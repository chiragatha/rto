...
u=function(a,b,d){for(var b=[].concat(b),c=b.length;c--;){var j=a["on"+b[c]];if("function"===typeof j)try{j.call(a,d||a)}catch(f){C(f)}}},x=function(a){return/^\s*(?:text\/\S*|application\/xml|\S*\/\S*\+xml)\s*;.*charset\s*=\s*utf-8/i.test(a.type)?new Blob(["ï»¿",a],{type:a.type}):a},y=function(a,b){var a=x(a),d=this,c=a.type,j=!1,f,g,h=function(){u(d,["writestart","progress","write","writeend"])},m=function(){if(j||!f)f=(e.URL||e.webkitURL||e).createObjectURL(a);g?g.location.href=f:void 0===e.open(f,
